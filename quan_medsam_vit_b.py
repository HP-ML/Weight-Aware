...
parser.add_argument('--model', type=str, default="vit_b", choices=['tiny_vit', 'vit_b'])
...
data_root = '/data/hp/medsam_auto/train_data/CT/AbdomenCT1K'
train_dataset = NpyDataset_vit_b(data_root=data_root, bbox_shift=5)
...
if args.save:
    ...
    makedirs('./quan_vit_b_ckpt/rtn', exist_ok=True)
    torch.save(modelp.state_dict(), './quan_vit_b_ckpt/rtn/medsam_tinyvit_2bit.pth')
